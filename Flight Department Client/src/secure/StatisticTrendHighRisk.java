...
public class StatisticTrendHighRisk extends JFrame {

    private Object[] events = null;

    public StatisticTrendHighRisk() {
        initComponents();
        retrieve();
        jPanel2.revalidate();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: High Risks Trend");
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        Color back = new Color(249, 236, 229);
        ...
        objArrayOfCalulatedRisks = new StatisticDBUpdater().getDataHighRiskTrend(startDate, finishDate);
        ...
        if (rbHorizont.isSelected()) {
            barChart = ChartFactory.createBarChart("Динамика событий высокого уровня риска за период с " + startDateForGraph + " по " + finishDateForGraph, "Дата", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
        } else {
            barChart = ChartFactory.createBarChart("Динамика событий высокого уровня риска за период с " + startDateForGraph + " по " + finishDateForGraph, "Дата", "Количество событий", barChartData, PlotOrientation.HORIZONTAL, false, true, false);
        }
        ...
        final CategoryItemRenderer renderer = new BarChartRenderer(
                new Paint[]{orangeMatrix, orangeMatrix, orangeMatrix,
                        orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix,
                        orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix,
                        orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix,
                        orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix,
                        orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix, orangeMatrix});
