...
public class ColorRenderer extends DefaultTableCellRenderer {
    ...
    private static final int COLORED_COLUMN_RISK = 11;
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (table.getValueAt(row, COLORED_COLUMN_RISK) != null) {
            String riskValue = table.getValueAt(row, COLORED_COLUMN_RISK).toString();
