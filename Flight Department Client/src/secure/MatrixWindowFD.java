...
public class MatrixWindowFD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bNotProc = new javax.swing.JButton();
        bNotAct = new javax.swing.JButton();
        ...
        bNotProc.setBackground(new java.awt.Color(255, 255, 255));
        bNotProc.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        bNotProc.setText("Не учитывать");
        bNotProc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bNotProcActionPerformed(evt);
            }
        });

        bNotAct.setBackground(new java.awt.Color(255, 255, 255));
        bNotAct.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        bNotAct.setText("Не действительно");
        bNotAct.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bNotActActionPerformed(evt);
            }
        });
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(bNotProc, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(bNotAct, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(bNotProc, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(bNotAct, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
// Matrix button 1 
        this.parent.setTfRiskIndexFD("Низкий риск - 1", greenMatrix);
        this.parent.setTfIndexFD("1");
        this.dispose();
    }//GEN-LAST:event_b1ActionPerformed

    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
// Matrix button 2
        this.parent.setTfRiskIndexFD("Низкий риск - 2", greenMatrix);
        this.parent.setTfIndexFD("2");
        this.dispose();
    }//GEN-LAST:event_b2ActionPerformed

    private void b4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b4ActionPerformed
// Matrix button 4
        this.parent.setTfRiskIndexFD("Низкий риск - 4", greenMatrix);
        this.parent.setTfIndexFD("4");
        this.dispose();
    }//GEN-LAST:event_b4ActionPerformed

    private void b10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b10ActionPerformed
// Matrix button 10
        this.parent.setTfRiskIndexFD("Низкий риск - 10", greenMatrix);
        this.parent.setTfIndexFD("10");
        this.dispose();
    }//GEN-LAST:event_b10ActionPerformed

    private void b20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b20ActionPerformed
// Matrix button 20
        this.parent.setTfRiskIndexFD("Умеренный риск - 20", yellowMatrix);
        this.parent.setTfIndexFD("20");
        this.dispose();
    }//GEN-LAST:event_b20ActionPerformed

    private void b21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b21ActionPerformed
// Matrix button 21
        this.parent.setTfRiskIndexFD("Умеренный риск - 21", yellowMatrix);
        this.parent.setTfIndexFD("21");
        this.dispose();
    }//GEN-LAST:event_b21ActionPerformed

    private void b50ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b50ActionPerformed
// Matrix button 50
        this.parent.setTfRiskIndexFD("Умеренный риск - 50", yellowMatrix);
        this.parent.setTfIndexFD("50");
        this.dispose();
...
// Matrix button 100
        this.parent.setTfRiskIndexFD("Высокий риск - 100", orangeMatrix);
        this.parent.setTfIndexFD("100");
        this.dispose();
...
// Matrix button 101
        this.parent.setTfRiskIndexFD("Высокий риск - 101", orangeMatrix);
        this.parent.setTfIndexFD("101");
        this.dispose();
...
// Matrix button 102
        this.parent.setTfRiskIndexFD("Высокий риск - 102", orangeMatrix);
        this.parent.setTfIndexFD("102");
        this.dispose();
...
// Matrix button 500
        this.parent.setTfRiskIndexFD("Недопустимый риск - 500", redMatrix);
        this.parent.setTfIndexFD("500");
        this.dispose();
...
// Matrix button 502
        this.parent.setTfRiskIndexFD("Недопустимый риск - 502", redMatrix);
        this.parent.setTfIndexFD("502");
        this.dispose();
...
// Matrix button 2500
        this.parent.setTfRiskIndexFD("Недопустимый риск - 2500", redMatrix);
        this.parent.setTfIndexFD("2500");
        this.dispose();
    }//GEN-LAST:event_b2500ActionPerformed

    private void bNotProcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNotProcActionPerformed
// не учитывать
        this.parent.setTfRiskIndexFD("Не учитывать", Color.WHITE);
        this.parent.setTfIndexFD("0");
        this.dispose();
    }//GEN-LAST:event_bNotProcActionPerformed

    private void bNotActActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNotActActionPerformed
// не действительно
        this.parent.setTfRiskIndexFD("Не действительно", Color.WHITE);
        this.parent.setTfIndexFD("0");
        this.dispose();
    }//GEN-LAST:event_bNotActActionPerformed
    ...
    private javax.swing.JButton bNotAct;
    private javax.swing.JButton bNotProc;
