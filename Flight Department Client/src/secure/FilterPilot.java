...
public class FilterPilot extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Фильтр по пилоту");
    ...
    private void bSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSaveActionPerformed
        // Кнопка фильтра
        String pilotID = txtData.getText();
        int id = 0;
        try {
            id = Integer.parseInt(pilotID);
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(null, "Введите числовое значение для ID пилота!");
        }

        Login.w.retrieveFilterPilot(id);
        dispose();
