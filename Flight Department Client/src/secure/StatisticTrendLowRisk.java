...
public class StatisticTrendLowRisk extends JFrame {

    private Object[] events = null;

    public StatisticTrendLowRisk() {
        initComponents();
        retrieve();
        jPanel2.revalidate();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: Low Risks Trend");
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(panelChart, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 908, Short.MAX_VALUE)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        Color back = new Color(229, 249, 236);
        ...
        objArrayOfCalulatedRisks = new StatisticDBUpdater().getDataLowRiskTrend(startDate, finishDate);
        ...
        for (int i = 0; i < diagrammaDateList.length; i++) {
            barChartData.setValue(Integer.parseInt(diagrammaQuantity[i].toString()), "Уровень события", diagrammaDateList[i].toString());
        }

        //строим диаграмму
        JFreeChart barChart;
        if (rbHorizont.isSelected()) {
            barChart = ChartFactory.createBarChart("Динамика событий низкого уровня риска за период с " + startDateForGraph + " по " + finishDateForGraph, "Дата", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
        } else {
            barChart = ChartFactory.createBarChart("Динамика событий низкого уровня риска за период с " + startDateForGraph + " по " + finishDateForGraph, "Дата", "Количество событий", barChartData, PlotOrientation.HORIZONTAL, false, true, false);
        }
        ...
        final CategoryItemRenderer renderer = new BarChartRenderer(
                new Paint[]{greenMatrix, greenMatrix, greenMatrix,
                        greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix,
                        greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix,
                        greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix,
                        greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix,
                        greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix, greenMatrix});
