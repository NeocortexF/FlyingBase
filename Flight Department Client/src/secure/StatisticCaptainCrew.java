...
public class StatisticCaptainCrew extends JFrame {

    private Object[] events = null;

    public StatisticCaptainCrew() {
        initComponents();
        retrieve();
        jPanel2.revalidate();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: Captain Crew Statistics ");
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(tfEvent, javax.swing.GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(tfEvent, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                                        ...
                                        .addComponent(chooserMonthFinish, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE))
                                .addContainerGap())
        );
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        if (tfEvent.getText().length() < 4 || tfEvent.getText().length() > 5) {
            ...
            dataFromSQL = new StatisticDBUpdater().getDataCaptainCrew(startDate, finishDate, eventNbr);
            ...
            JFreeChart barChart = ChartFactory.createBarChart("Количество событий AirFASE №" + eventNbr + " за период с " + startDateForGraph + " по " + finishDateForGraph + ". КВС экипаж.", "КВС", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
            ...
            Color col10 = new Color(241, 92, 42);
            Color back = new Color(237, 222, 218);
