...
public class StatisticIndividual extends JFrame {

    private Object[] events = null;

    public StatisticIndividual() {
        initComponents();
        retrieve();
        jPanel2.revalidate();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: Individual Statistics ");
        ...
        jLabel5.setText("Табельный");

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pilotNew.png"))); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                ...
                                                .addComponent(jButton1))
                                        .addComponent(chooserMonthStart, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                                        .addComponent(chooserYearStart, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                                        .addComponent(chooserYearFinish, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        if (tfEvent.getText().length() < 1 || tfEvent.getText().length() > 6) {
            JOptionPane.showMessageDialog(null, "Введите правильный табельный номер!");
        } else {
            ...
            String pilotID = tfEvent.getText();
            dataFromSQL = new StatisticDBUpdater().getDataIndividual(startDate, finishDate, pilotID);
            ...
            if (dataFromSQL.length > 20) {
                ...
                for (int i = 2; i < dataFromSQL.length; i = i + 2) {
                    int quantity = Integer.parseInt(dataFromSQL[i + 1].toString());
                    barChartData.setValue(quantity, "Номер события", dataFromSQL[i].toString());
                }
            }
            ...
            JFreeChart barChart = ChartFactory.createBarChart("Индивидуальная статистика для " + name + " табельный №" + pilotID + "\nАвиаэскадрилья: " + ae + " Должность: " + position + " \nза период с " + startDateForGraph + " по " + finishDateForGraph, "Номер события AirFASE", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
            ...
            Color col10 = new Color(145, 135, 90);
            //   Color back = new Color(234, 240, 247);
    ...
    public void setParent(StatisticIndividual s) {
        this.parent = s;
    }
    ...
    public void setKVSid(String id) {
        this.tfEvent.setText(id);
    }

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PersonnelStatistic perSt = new PersonnelStatistic();
        perSt.setParent(this);
        perSt.setVisible(true);
