...
public class StatisticPilotsInEvents extends JFrame {

    private Object[] events = null;

    public StatisticPilotsInEvents() {
        initComponents();
        retrieve();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: Top Pilots Summary");
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        if (startDate != null && finishDate != null) {
            ...
            System.out.println(startDateForSQL);
            System.out.println(finishDateForSQL);

            arrayOfCalulatedRisks = new StatisticDBUpdater().getDataPilotsSummary(startDateForSQL, finishDateForSQL);
            ...
            int n = 0;
            for (int i = 0; i < 10; i++) {
                int quantity = Integer.parseInt(arrayOfCalulatedRisks[n + 1].toString());
                n++;
                barChartData.setValue(quantity, "Табельный номер", arrayOfCalulatedRisks[n - 1].toString());
                n++;
            }

            JFreeChart barChart = ChartFactory.createBarChart("Топ 10 по ЛО за период с " + startDateForGraph + " по " + finishDateForGraph, "Табельный номер", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
            ...
            Color col1 = new Color(18, 70, 165);
            Color col2 = new Color(17, 93, 165);
            Color col3 = new Color(17, 110, 165);
            Color col4 = new Color(17, 135, 165);
            Color col5 = new Color(17, 165, 162);
            Color col6 = new Color(17, 165, 132);
            Color col7 = new Color(17, 165, 110);
            Color col8 = new Color(17, 165, 63);
            Color col9 = new Color(17, 165, 34);
            Color col10 = new Color(34, 165, 17);
