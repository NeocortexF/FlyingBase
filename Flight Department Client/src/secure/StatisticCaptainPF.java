...
public class StatisticCaptainPF extends JFrame {

    private Object[] events = null;

    public StatisticCaptainPF() {
        initComponents();
        retrieve();
        jPanel2.revalidate();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Flying Base: Captain PF Statistics ");
    ...
    private void bSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSelectActionPerformed
        ...
        if (tfEvent.getText().length() < 4 || tfEvent.getText().length() > 5) {
            ...
            dataFromSQL = new StatisticDBUpdater().getDataCaptainPF(startDate, finishDate, eventNbr);
            ...
            JFreeChart barChart = ChartFactory.createBarChart("Количество событий AirFASE №" + eventNbr + " за период с " + startDateForGraph + " по " + finishDateForGraph + ". Пилотирующий: КВС.", "КВС", "Количество событий", barChartData, PlotOrientation.VERTICAL, false, true, false);
            ...
            Color col10 = new Color(43, 119, 242);
