...
public class WindowMenuCom extends JFrame {
    ...
    private void getDataOptions() {
        ...
        Statement s = null;
        ResultSet rs = null;
        String sql = "SELECT * FROM escadra WHERE id = 1";
        try {
    ...
    private boolean setDataOptions() {
        String name = jTextField1.getText();
        Connection con = null;
        PreparedStatement s = null;
        String sql = "UPDATE escadra SET name = ? WHERE id = 1";
        try {
            con = DriverManager.getConnection(Main.conIninialiazedStr, Main.username, Main.password);
            s = con.prepareStatement(sql);
            s.setString(1, name);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Введите фамилию и инициалы командира авиаэскадрильи:");
