...
public class DBUpdaterEvent1 extends JFrame {
    ...
    public DefaultTableModel getData(String str) {
        DefaultTableModel dmEv1 = new DefaultTableModel() {
        ...
        dmEv1.addColumn("AirFASE Event 1");
        dmEv1.addColumn("Классификация события");
        dmEv1.addColumn("Предварительная оценка риска");
        dmEv1.addColumn("Индекс");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String airEvent1 = rs.getString(23);
                String classification = rs.getString(22);
                String assess = rs.getString(24);

                if (assess != null) {
                    if (assess.contains("Низкий")) {
                        dmEv1.addRow(new Object[]{airEvent1, classification, assess, iconGreen});
                    } else if (assess.contains("Умеренный")) {
                        dmEv1.addRow(new Object[]{airEvent1, classification, assess, iconYellow});
                    } else if (assess.contains("Высокий")) {
                        dmEv1.addRow(new Object[]{airEvent1, classification, assess, iconOrange});
                    } else if (assess.contains("Недопустимый")) {
                        dmEv1.addRow(new Object[]{airEvent1, classification, assess, iconRed});
                    } else {
                        dmEv1.addRow(new Object[]{airEvent1, classification, assess, iconWhite});
                    }
                }
            }
            return dmEv1;
