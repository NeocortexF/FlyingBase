...
public class WorkingWindowCreate extends javax.swing.JFrame {
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        ...
                                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(comboProcBy, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(bSave)))
                                .addContainerGap())
        );
    ...
    private void bSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSaveActionPerformed
        ...
        if (jdateProcessing.getDate() == null || jdateFlight.getDate() == null) {
            ...
            String readyStringNbr = preffics + "-" + incNbr;
            //передаем значение в ячейку формы
            String checkNbr = txtIncomingNbr.getText();

            if (!checkNbr.equals(readyStringNbr)) {
                txtIncomingNbr.setText(readyStringNbr);
                JOptionPane.showMessageDialog(null, "Номер события " + checkNbr + " уже занят в базе данных. Ваша запись получила номер " + readyStringNbr);
            }
            ...
            if (new DBUpdaterWorkingWindow().add(txtIncomingNbr.getText(), jdateProcessing.getDate(), jdateFlight.getDate(),
                ...
                JOptionPane.showMessageDialog(null, "Не получилось сохранить, пожалуйста, проверьте соедниение с базой данных!");
            }
        }
