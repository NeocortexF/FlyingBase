...
public class Welcome extends JFrame {
    ...
    private void initComponents() {
        ...
        mnuAirports = new javax.swing.JMenu();
        ...
        mnuAirports.setText("Справочники");

        mnuAirportEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/dictionary.png"))); // NOI18N
        mnuAirportEdit.setText("Редактировать справочник аэропортов");
        mnuAirportEdit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuAirportEditActionPerformed(evt);
            }
        });
        mnuAirports.add(mnuAirportEdit);

        jMenuBar1.add(mnuAirports);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            Boolean accessGranted = new DBUpdaterWorkingWindow().checkAccess(str);
    ...
    private void mnuAirportEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuAirportEditActionPerformed
        AirportsDictionary airDict = new AirportsDictionary();
        airDict.setVisible(true);
    }//GEN-LAST:event_mnuAirportEditActionPerformed
    ...
    private javax.swing.JMenu mnuAirports;
